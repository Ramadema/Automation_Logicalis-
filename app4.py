#Versión multihilo usando ThreadPoolExecutor con 8 workers para acelerar las búsquedas. Utiliza requests para conexiones estables y filtra resultados directamente durante el scraping, logrando buen equilibrio entre velocidad y compatibilidad.
...
with ThreadPoolExecutor(max_workers=8) as executor:  # ⚡ Subimos el máximo de workers
